...
/**
 * Created by wanggc on 2017/11/29.
 */
...
public class DateDialogActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.date_dialog_learn);
        ...
        dateBn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View source) {
                ...
                new DatePickerDialog(DateDialogActivity.this,
                        // 绑定监听器
        ...
        timeBn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View source) {
                ...
                new TimePickerDialog(DateDialogActivity.this,
                        // 绑定监听器
